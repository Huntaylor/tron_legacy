  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        if (constraints.maxWidth <= TronLegacyBreakpoints.small) {
          return small(context, child);
        }
        else if (constraints.maxWidth <= TronLegacyBreakpoints.medium) {
          return (medium ?? large).call(context, child);
        }
        else if (constraints.maxWidth <= TronLegacyBreakpoints.large) {
